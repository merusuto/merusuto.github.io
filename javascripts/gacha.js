...
(function() {
  ...
  initGacha = function(data) {
    ...
    preloadCallback = function() {
      ...
      if (preloadCount === 0) {
        ...
        return startGacha(pickedData);
      }
    };
    $preload = $("#preload");
    preloadImage = function(url) {
      preloadCount += 1;
      return $("<img src='" + url + "' />").appendTo($preload).load(preloadCallback).error(preloadCallback);
    };
  ...
  startGacha = function(pickedData) {
    ...
    callbacks.push(function() {
      ...
      setTimeout(function() {
        return $lastActive.addClass("active-300");
      }, 300);
    ...
    callbacks.push(function() {
      ...
      return setTimeout(function() {
        busy = false;
        return $foreground.on("click", function() {
          var $body;
          $body = $("body");
          $body.prepend($body.data("html"));
          return $page.fadeOut(200, function() {
            $page.remove();
    ...
    $foreground.on("click", function() {
      var _base;
      if (!busy) {
        busy = true;
        return typeof (_base = callbacks.shift()) === "function" ? _base() : void 0;
      }
    });
    return $foreground.on("click", ".skip", function(event) {
      var _base;
      event.stopPropagation();
      if (typeof (_base = callbacks.pop()) === "function") {
        _base();
      }
      return callbacks = [];
    });
